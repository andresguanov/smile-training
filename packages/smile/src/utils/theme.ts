  ...
  return {
    ...
    extend: {
      colors: {
        ...
        // text and icons
        's-text-primary': colors.slate[900],
        's-text-secondary': colors.slate[700],
        's-text-tertiary': colors.slate[500],
        's-text-placeholder': colors.slate[400],
        's-text-disabled': colors.slate[300],
        's-text-inverse': colors.white,
        // borders
        's-border-subtle': colors.slate[200],
        's-border-regular': colors.slate[300],
        's-border-inverse': convertHexToRgba(colors.white, 0.2),
        // 's-border-active': withOpacity('--sm-color-primary-600'),
        's-border-active': primaryColors['sm-primary-600'],
        // borders:pseudo
        's-border-subtle-hover': convertHexToRgba(colors.slate[400], 0.4),
        's-border-regular-active': convertHexToRgba(colors.slate[500], 0.4),
        // primary
