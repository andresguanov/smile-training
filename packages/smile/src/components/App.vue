<template>
  <div class="app_container">
    <s-accordion>
      ...
      <s-accordion-item title="Option 2" description="Description 2">
        <p>Content 2</p>
      </s-accordion-item>
      <s-accordion-item title="Option 3" description="Description 3">
        <p>Content 3</p>
      </s-accordion-item>
      <s-accordion-item title="Option 4" description="Description 4">
        <p>Content 4</p>
      </s-accordion-item>
    </s-accordion>
